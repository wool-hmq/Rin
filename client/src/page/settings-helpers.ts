...
export const AI_MODEL_PRESETS: Record<string, string[]> = {
  "worker-ai": ["kimi-k2.7-code", "glm-4.7-flash", "gpt-oss-120b", "gpt-oss-20b", "llama-4-scout", "gemma-4-26b", "qwen3-30b", "mistral-small-3.1-24b", "nemotron-3-120b", "deepseek-r1-32b"],
