...
如需配置 OAuth，需要创建一个 OAuth App，回调地址为 `http://localhost:11498/api/user/github/callback`（GitHub）、`http://localhost:11498/api/user/gitee/callback`（Gitee）或联系心月互联获取 QQ 登录 Token。
:::
